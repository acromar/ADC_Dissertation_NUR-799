# Cleaning Raw 2017 YRBSS data
# Aaron Cromar
# 09-06-2023

---
title: "Cleaning 2017 YRBS Dataset"
author: "Aaron Cromar"
date: "2023-09-06"
output:
...
# Loading Raw YRBS 2017 Data

```{r}
load("data/raw2017YRBS.rda")
```

# Loading Raw YRBS 2017 Dataframe

```{r}
raw_2017YRBS_df <- tidyREDCap::drop_labels(raw2017YRBS)
```

# 14765 x 240

# Recoding the 2017 YRBS Binary Factors
...
#Tidying Raw 2017 YRBS Dataframe

```{r}
clean_2017YRBS <-
  raw_2017YRBS_df |>
  select(weight, stratum, psu, Q1, Q2, Q3, Q4, Q5, raceeth, Q16:Q29, Q67, Q80:Q81, QN16:QN29, QN80:QN81) |>
  mutate(
    Sex = case_when(
      Q2 == 2 ~ "Male",
      Q2 == 1 ~ "Female",
  ...
  mutate(
    MDTM4_HoursofComputer_VideoGames = case_when(
      ...
      QN81 == 1 ~ "Yes",
      TRUE ~ NA_character_)) |>
  mutate(across(c(Q1, Q2, Q3, Q4, Q5, raceeth, Q16:Q29, Q67, Q80:Q81, QN16:QN29, QN80:QN81), factor))
view(clean_2017YRBS)
```
  
# 14765 x 80

#Adding 2017 Year Column to the Clean 2017 YRBS Dataframe(.RDS)

```{r}
clean_2017YRBS$year=2017
```

# 16410 x 81

#Saving Clean 2017 YRBS Dataframe(.RDS)

```{r}
saveRDS(file="clean_2017YRBS.rds", clean_2017YRBS)
```
