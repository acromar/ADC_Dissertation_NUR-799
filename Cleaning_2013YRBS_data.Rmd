# Cleaning Raw 2013 YRBSS data
# Aaron Cromar
# 09-06-2023

---
title: "Cleaning 2013 YRBS Dataset"
author: "Aaron Cromar"
date: "2023-09-06"
output:
...
# The following script aims to generate a clean data set for YRBS 2013 using the
...
# Loading Raw YRBS 2013 Data

```{r}
load("data/raw2013YRBS.rda")
```

# Loading Raw YRBS 2013 Dataframe

```{r}
raw_2013YRBS_df <- tidyREDCap::drop_labels(raw2013YRBS)
```
...
#Tidying Raw 2013 YRBS Dataframe

```{r}
clean_2013YRBS <-
  raw_2013YRBS_df |>
  select(weight, stratum, psu, Q1, Q2, Q3, Q4, Q5, raceeth, Q17:Q30, Q81:Q82, QN17:QN30, QN81:QN82) |>
  mutate(
    Sex = case_when(
      Q2 == 2 ~ "Male",
      Q2 == 1 ~ "Female",
  ...
  mutate(
    MDTM4_HoursofComputer_VideoGames = case_when(
      ...
      QN82 == 1 ~ "Yes",
      TRUE ~ NA_character_)) |>
  mutate(across(c(Q1, Q2, Q3, Q4, Q5, raceeth, Q17:Q30, Q81:Q82, QN17:QN30, QN81:QN82), factor))
view(clean_2013YRBS)
```
  
# 13583 x 78

#Adding 2013 Year Column to the Clean 2013 YRBS Dataframe(.RDS)

```{r}
clean_2013YRBS$year=2013
```

# 16410 x 79

#Saving Clean 2013 YRBS Dataframe(.RDS)

```{r}
saveRDS(file="clean_2013YRBS.rds", clean_2013YRBS)
```
