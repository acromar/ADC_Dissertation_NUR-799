# Cleaning Raw 2015 YRBSS data
# Aaron Cromar
# 09-06-2023

---
title: "Cleaning 2015 YRBS Dataset"
author: "Aaron Cromar"
date: "2023-09-06"
output:
...
# The following script aims to generate a clean data set for YRBS 2015 using the
...
# Loading Raw YRBS 2015 Data

```{r}
load("data/raw2015YRBS.rda")
```

# Loading Raw YRBS 2015 Dataframe

```{r}
raw_2015YRBS_df <- tidyREDCap::drop_labels(raw2015YRBS)
```

# 15624 x 239

# Recoding the 2015 YRBS Binary Factors
...
#Tidying Raw 2015 YRBS Dataframe

```{r}
clean_2015YRBS <-
  raw_2015YRBS_df |>
  select(weight, stratum, psu, Q1, Q2, Q3, Q4, Q5, raceeth, Q17:Q30, Q68, Q81:Q82, QN17:QN30, QN81:QN82) |>
  mutate(
    Sex = case_when(
      Q2 == 2 ~ "Male",
      Q2 == 1 ~ "Female",
  ...
  mutate(
    RSA3_SchoolPhysicalFight = case_when(
      ...
      Q20 == 5 ~ "6 or 7 times",
      Q20 == 6 ~ "8 or 9 times",
      Q20 == 7 ~ "10 or 11 times",
      Q20 == 8 ~ "12 or more times",
      TRUE ~ NA_character_)) |>
  mutate(
  ...
  mutate(
    MDTM4_HoursofComputer_VideoGames = case_when(
      ...
      QN82 == 1 ~ "Yes",
      TRUE ~ NA_character_)) |>
  mutate(across(c(Q1, Q2, Q3, Q4, Q5, raceeth, Q17:Q30, Q68, Q81:Q82, QN17:QN30, QN81:QN82), factor))
view(clean_2015YRBS)
```
  
# 15624 x 80

#Adding 2015 Year Column to the Clean 2015 YRBS Dataframe(.RDS)

```{r}
clean_2015YRBS$year=2015
```

# 16410 x 81

#Saving Clean 2015 YRBS Dataframe(.RDS)

```{r}
saveRDS(file="clean_2015YRBS.rds", clean_2015YRBS)
```
